...
public class Usuario {
    ...
    public Usuario(int id, String nombre, String contraseña, String correoElectronico, String fechaDeNacimiento,
            String peso, String altura, String frecuenciaDeEjercicio) {
        this.id = id;
        this.nombre = nombre;
